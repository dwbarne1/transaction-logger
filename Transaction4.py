...
# Transactions list initialized
transactions = [['DateTime', 'Name', 'Old Balance', 'Amount', 'New Balance']]
...
while tries <= maxTries:
    ...
    # Verify entered pin is a key in accounts
        ...
        oldBalance = accounts[pin][selection]
        ...
        newBalance = accounts[pin][selection]
        transactions.append([time.ctime(),
                            accounts[pin]['Name'],
                            logger.format_money(oldBalance),
                            logger.format_money(amount),
                            logger.format_money(newBalance)])
